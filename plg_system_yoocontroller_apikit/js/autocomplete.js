(function ($) {
  ...
  const handlers = {
    ...
    onItemSelected: function (e) {
      ...
      // console.log($this);
      $this.searchBox[0].dispatchEvent(new Event("input", { composed: true }));
    },
  ...
  const Autocomplete = (function () {
    ...
    Autocomplete.prototype = {
      ...
      init: function () {
        ...
        //this.searchBox.wrap(`<span class="autocomplete ${options.wrapClass}">`);
        this.element = this.searchBox.parent();
        this.searchBox.parent().addClass("autocomplete");
        //console.log(this.searchBox.parent());
        //this.element.append(this.list);
        this.searchBox.parent().append(this.list);
